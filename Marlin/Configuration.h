...
#define STRING_CONFIG_H_AUTHOR "(Sinzan Edit, Ender-3 Pro)" // Who made the changes. // Sinzan
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_E3_TURBO //Sinzan
#endif
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //Sinzan
#define Y_DRIVER_TYPE  TMC2209 //Sinzan
#define Z_DRIVER_TYPE  TMC2209 //Sinzan
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209 //Sinzan
...
#define E0_DRIVER_TYPE TMC2209 //Sinzan
...
#define TEMP_SENSOR_CHAMBER 1 //Sinzan
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.73,  21.73 } //Sinzan
    #define DEFAULT_Ki_LIST {   1.54,   1.54 } //Sinzan
    #define DEFAULT_Kd_LIST {  76.55,  76.55 } //Sinzan
  #else
    #define DEFAULT_Kp  21.73 //Sinzan
    #define DEFAULT_Ki   1.54 //Sinzan
    #define DEFAULT_Kd  76.55 //Sinzan
  #endif
#else
...
#define PIDTEMPBED //Sinzan
  ...
  #define DEFAULT_bedKp 50.71 //Sinzan
  #define DEFAULT_bedKi 9.88 //Sinzan 
  #define DEFAULT_bedKd 173.43 //Sinzan 
...
#define EXTRUDE_MAXLENGTH 600 //Sinzan
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 405 } //Sinzan
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 60 } //Sinzan
 ...
 */
#define DEFAULT_ACCELERATION          500    // X, Y, Z and E acceleration for printing moves //Sinzan
#define DEFAULT_RETRACT_ACCELERATION  500    // E acceleration for retracts //Sinzan
#define DEFAULT_TRAVEL_ACCELERATION   500    // X, Y, Z acceleration for travel (non printing) moves //Sinzan
 ...
 */
#define S_CURVE_ACCELERATION //Sinzan
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, -16, -4.17 } //Sinzan
...
#define DISABLE_X false //Sinzan
#define DISABLE_Y false //Sinzan
#define DISABLE_Z false //Sinzan
//#define DISABLE_I
//#define DISABLE_J
//#define DISABLE_K
//#define DISABLE_U
...
#define DISABLE_E false             // Disable the extruder when not stepping //Sinzan
#define DISABLE_OTHER_EXTRUDERS   // Keep only the active extruder enabled

// @section motion

// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way.
#define INVERT_X_DIR true //Sinzan
...
#define X_BED_SIZE 235 //Sinzan
#define Y_BED_SIZE 235 //Sinzan
...
#define AUTO_BED_LEVELING_UBL //Sinzan
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //Sinzan
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION //Sinzan
  ...
  #define GRID_MAX_POINTS_X 5 //Sinzan
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID //Sinzan
  ...
  #define MESH_INSET 35              // Set Mesh bounds as an inset region of the bed //Sinzan
  ...
  #define UBL_MESH_WIZARD         // Run several commands in a row to get a complete mesh //Sinzan
 ...
 */
#define LCD_BED_LEVELING //Sinzan

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        // Add a menu to edit mesh points //Sinzan
#endif

// Add a menu item to move between bed corners for manual bed adjustment
#define LCD_BED_TRAMMING //Sinzan
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (20*60) } //Sinzan
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors. //Sinzan
...
#define PREHEAT_1_TEMP_HOTEND 185 //Sinzan
#define PREHEAT_1_TEMP_BED     45 //Sinzan
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     255 // Value from 0 to 255 //Sinzan

#define PREHEAT_2_LABEL       "ABS"
#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED    110
#define PREHEAT_2_TEMP_CHAMBER 35
#define PREHEAT_2_FAN_SPEED     255 // Value from 0 to 255 //Sinzan
 ...
 */
#define NOZZLE_PARK_FEATURE //Sinzan
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //Sinzan
...
//
#define CR10_STOCKDISPLAY //Sinzan
